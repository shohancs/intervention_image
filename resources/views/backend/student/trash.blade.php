		...
		<div class="card radius-10">
			<div class="card-body">
				<div class="d-flex align-items-center">
					<div>
						<h5 class="mb-0">Trash Folder Student</h5>
					</div>
				</div>
							...
							<tr>
								...
								<td class="text-center">
									<div>
										...
										<a href="" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#trashData{{ $readStudent->id }}">Delete</a>
									</div>
									<!-- Modal Start -->
									  ...
									  <div class="modal-dialog">
									    <div class="modal-content">
									      <div class="modal-header">
									        <h1 class="modal-title fs-5" id="exampleModalLabel">Through into <span class="text-danger">{{ $readStudent->name }}</span> Delete?</h1>
										        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
									      </div>
									      <div class="modal-body">
									        <form action="{{ route('student.destroy', $readStudent->id) }}" method="POST">
									        	@csrf
